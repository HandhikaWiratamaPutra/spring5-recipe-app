...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    @Override
    @Transactional      //untuk handling lazy initialization exception
...
//        guacNotes.setRecipe(guacRecipe);      //no need anymore because already added when recipe.setNote
        guacRecipe.setNotes(guacNotes);
        //very redundant, could add helper method, and make this simpler, delete recipe parameter
...
//        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chopped", new BigDecimal(".5"), eachUom));
        ...
        guacRecipe.setUrl("Read more: http://www.simplyrecipes.com/recipes/perfect_guacamole/#ixzz4jvoun5ws");
